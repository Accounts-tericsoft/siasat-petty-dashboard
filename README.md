...
ledger kept by the Siasat office and MJ), Jan–Sep 2026 — 3,644 transactions, ₹38.8 L.

Open `dashboard.html` in any browser. No build step; Chart.js via CDN. All 3,644 rows
