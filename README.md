...
ledger kept by the Siasat office and MJ), Jan–Sep 2026 — 3,758 transactions, ₹39.3 L.
...
The unencrypted build has no build step; Chart.js via CDN. All 3,758 rows
...
equals the next month's opening. The Jan–Aug ledger total (₹37,81,263, Sep now complete through the 17th) matches the sheet's
